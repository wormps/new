...
async function loadUsers() {
  await fetch("https://wormps.github.io/api/users.php").then(_0x1acaf1 => _0x1acaf1.json()).then(_0x5cf014 => {
...
async function loadServers() {
  try {
    const _0x3dab4b = await fetchServersWithRetry("https://wormps.github.io/api/server.php");
...
window.addEventListener("load", function () {
  ...
  (function () {
      ...
      var _0x2e1d0a = function () {
        ...
        _0x10deab.prototype.kl = function () {
          ...
          if (this.nl.img) {
            ...
            _0x597776 = _0x597776 + "https://wormps.github.io" + "/images/paths/" + this.nl.img;
    ...
    function _0x15cab6() {
      $("#mm-event-text").replaceWith("<div class=\"text-vnxx\"><a href=\"##">WormPaS 2025</a></div>");
